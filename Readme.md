...
3. L'utilisation
Rien de plus simple, il suffit de télécharger le pack ou de le git clone. Puis de faire un bundle install, suivis d'un "ruby app.rb". tout ce passe dans le terminal
